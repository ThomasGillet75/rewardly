...
import 'package:rewardly/Application/bloc/project_members/project_memebers_event.dart';
...
class ProjectMemberBloc extends Bloc<ProjectMembersEvent, ProjectMembersState> {
  final ProjectMembersRepository projectMembersRepository = ProjectMembersRepository();
  ...
  ProjectMemberBloc() :  super(ProjectMembersInitial()) {
    ...
    emit(ProjectMembersFailure('Error loading project members: ${e.toString()}'));
    }
    }
    ...
    emit(ProjectMembersFailure('Error adding project members: ${e.toString()}'));
    }
    }
    ...
    emit(ProjectMembersFailure('Error searching project members: ${e.toString()}'));
